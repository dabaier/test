...
<div id="cover" style="min-height: 639px;">
    <div id="user_area">
        <div id="home_header">
            ...
            <a href="<%=basePath%>goods/homeGoods">
                 <img src="<%=basePath%>img/homeheader1.png"  style="margin-left: 25px;" >
                 <!-- <span >校园二手市场</span> -->
            </a>
        ...
        <div id="user_content">
            <div class="basic">
                <form:form action="../goods/publishGoodsSubmit" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <input type="submit" class="setting-save" value="发布物品" style="margin-top: 20px;margin-left:460px;background-color: #4FBEF6;"/>
                </form:form>
            </div>
            <!--
