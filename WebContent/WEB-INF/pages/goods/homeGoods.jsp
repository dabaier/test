            ...
            <div class="row">
                <a onclick="showLogin()">
                    <div class="col s12 title">
                    	<span style="color:grey;font-size:50px;margin-top:30px;margin-left:85px;">登录</span>
                    </div>
                </a>
        ...
        <div class="publish-box z-depth-4">
            <div class="row">
                <a onclick="showSignup()">
                    <div class="col s12 title">
                    	<span style="color:grey;font-size:50px;margin-top:30px;margin-left:85px;">注册</span>
                    </div>
                </a>
            ...
            <ul class="slides" style="height: 400px;">
                <li class="active" style="opacity: 1;">
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                <p class="text1">终于等到你啦！</p>
                                <p class="text2">你是否在为闲置而烦恼？</p>
                                <p class="text3">你是否想淘到物美价廉的好物？</p>
                                <p class="text4">欢迎在我们的小市场闲逛！</p>
                                <p class="text5">相信你能找到你想要的哦！</p>
