...
<div ng-controller="loginController" class="ng-scope">
    <div id="login-show" class="login stark-components">
        <div class="publish-box z-depth-4">
            <div class="row">
                <a onclick="showLogin()">
                    <div class="col s12 title"><span style="color:grey;font-size:50px;margin-top:30px;margin-left:85px;">登录</span></div>
                </a>
        ...
        <div class="publish-box z-depth-4">
            <div class="row">
                <a onclick="showSignup()">
                    <div class="col s12 title"><span style="color:grey;font-size:50px;margin-top:30px;margin-left:85px;">注册</span></div>
                </a>
...
<div ng-controller="detailBoxController" class="detail-box stark-components z-depth-1 row ng-scope">
    ...
    <div class="col s6">
        ...
        <div class="item-public-info">
            ...
            <p>
                <i class="iconfont"></i>
                <em class="item-location">校园闲置</em>
            </p>
        </div>
