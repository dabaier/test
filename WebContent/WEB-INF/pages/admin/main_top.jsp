...
<body>
	...
	<div id="headers" >
	   	...
	   	<div style="float:letf;height:50px;background-color:D5D5D5;">
	   	<div style="float:left;background-color:#008FEE;height:50px;width:220px;">
	...
	<div id="user-nav" class="navbar navbar-inverse" >
		<ul class="nav" style="height:50px;background:#D5D5D5;">
